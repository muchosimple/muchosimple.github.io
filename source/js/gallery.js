/*
 * Gallery Content Type with Carousel
 *
 * @description:
...
(function() {
  ...
  function afterActionGallery(){
    ...
    var current = this.currentItem - slidesMinusAds + 1;

    // If gallery starts with a start slide, make that the 0 slide.
    if ($('.slide--start').length) {
      current = this.currentItem - slidesMinusAds;
    }
